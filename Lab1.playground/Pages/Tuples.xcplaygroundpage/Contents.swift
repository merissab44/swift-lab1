...
var USD: (currencyType: String, value: Double) = ("usd", 1.00)
var CAD: (currencyType: String, value: Double) = ("cad", USD.value * 1.29)
print("\(USD.value) \(USD.currencyType) is \(CAD.value) \(CAD.currencyType)")
var AUD: (currencyType: String, value: Double) = ("aud", USD.value * 1.36)
print("\(USD.value) \(USD.currencyType) is \(AUD.value) \(AUD.currencyType)")
